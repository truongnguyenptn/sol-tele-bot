...
const newUserHandler = async (bot: TelegramBot, msg: TelegramBot.Message) => {
  ...
  const caption =
    ...
    `<b>To get started, please read our <a href="https://x.com/OpenverseHQ">docs</a></b>`;
...
export const welcomeGuideHandler = async (
  ...
  const caption =
    `<b>Welcome to Bot trade</b>\n\n` +
    `The Unique Solana Trading Bot. Snipe, trade and keep track of your positions with Bot Trade.\n\n
    Developed by: @truongnguyenptn @OpenverseHQ` +
    ...
    `<b>Part of <a href="https://x.com/OpenverseHQ">OpenVerse</a>'s Ecosystem</b>\n\n` +
    // `-----------------------\n` +
